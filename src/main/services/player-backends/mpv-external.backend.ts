...
import { PlayerBackend, MpvTrack, PlayerState, PlayerAudioState, MpvAvailability } from './types';

export class MpvExternalBackend implements PlayerBackend {
...
export const mpvExternalBackend = new MpvExternalBackend();
